...
const releasedPluginName = 'powerhouse'
...
module.exports = {
	...
	hooks: {
		'before:init': [
			...
			'pnpm build-css:admin && echo ✅ build admin css success',
			'pnpm build-css:front && echo ✅ build front css success',
			'pnpm build-css:blocknote && echo ✅ build blocknote css success',
